      ...
      <div className='columns'>
        <div className='column is-one-third'>
          <div style={TextStyle}>
            ...
            <span className='BlackRegular'>We make food from responsibly produced raw<br/> 
        ...
        <div className='column is-one-third'>
          <div className='card' style={Card1Style}>
            <div className="card-content">
              <Link to={`/env/co2`}>
                <h1 className="title is-1 Bold" style={Title1Style}>CO2</h1>
              </Link>
              <span className='BlackRegular' style={SubTitle1Style}>Carbon <br/>Footprint</span>
            </div>
          </div>
        </div>
        <div className='column is-one-third'>
          <div className='card' style={Card2Style}>
            <div className="card-content">
              <Link to={`/env/h2o`}>
                <h1 class="title is-1 Bold" style={Title2Style}>H2O</h1>
              </Link>
              <span className='BlackRegular' style={SubTitle2Style}>Water <br/>Footprint</span>
            </div>
          </div>
        </div>
      </div>
